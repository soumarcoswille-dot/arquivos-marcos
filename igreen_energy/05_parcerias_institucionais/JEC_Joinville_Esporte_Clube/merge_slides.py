...
with open(r'c:\Users\lenovo\Documents\01. MARCOS\igreen_energy\05_parcerias_institucionais\JEC_Joinville_Esporte_Clube\index.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Merge 1: Slides 5 and 6
s56_start = content.find('<!-- 5. O Gatilho Regulatório -->')
s7_start = content.find('<!-- 7. iGreen Energy -->')

merge1_html = '''<!-- 5. Como Funciona -->
        ...
        '''
content = content[:s56_start] + merge1_html + content[s7_start:]

# Merge 2: Slides 9 and 10 -> Slide 8
s9_start = content.find('<!-- 9. O Potencial -->')
s11_start = content.find('<!-- 11. Risco Zero -->')

merge2_html = '''<!-- 8. Impacto Financeiro (Simulador) -->
        ...
        '''
content = content[:s9_start] + merge2_html + content[s11_start:]

# Merge 3: Slides 12 and 13 -> Slide 10
s12_start = content.find('<!-- 12. Calendário de Execução -->')
s14_start = content.find('<!-- 14. O Piloto -->')

merge3_html = '''<!-- 10. Execução em 4 Semanas -->
        ...
        '''
content = content[:s12_start] + merge3_html + content[s14_start:]

# Adjust slide numbers for remaining slides
...
with open(r'c:\Users\lenovo\Documents\01. MARCOS\igreen_energy\05_parcerias_institucionais\JEC_Joinville_Esporte_Clube\index.html', 'w', encoding='utf-8') as f:
    f.write(content)
print('Done!')
