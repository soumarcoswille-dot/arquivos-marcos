...
export function LandingFooter() {
    const whatsappLink = `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "5547997838464"}?text=Olá! Gostaria de saber mais sobre a Conexão Solar.`;
    return (
        <footer className="bg-muted/30 border-t border-border pt-24 pb-12 relative overflow-hidden text-foreground">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="flex flex-col items-center text-center mb-20 space-y-8">
                    ...
                    <Button asChild className="h-16 px-10 text-xl font-bold rounded-full bg-primary text-white hover:bg-primary/90 shadow-[0_0_40px_-10px_var(--primary)] animate-pulse hover:animate-none transition-all hover:scale-105">
                        <Link href={whatsappLink} target="_blank">
                            Quero meu Desconto Garantido
                        </Link>
                    </Button>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-12 border-t border-border pt-16 mb-12">
                    <div className="md:col-span-2 space-y-6">
                        <div className="text-2xl font-bold text-foreground">
                            iGreen<span className="text-secondary">Energy</span>
                        </div>
